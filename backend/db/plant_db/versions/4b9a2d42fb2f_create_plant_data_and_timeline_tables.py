"""Create Plant, Data, and Timeline tables

Revision ID: 4b9a2d42fb2f
Revises: 
Create Date: 2025-07-19 22:15:57.012418
...
def upgrade() -> None:
    ...
    sa.Column('vegetation_features', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('morphology_features', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('texture_features', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('plant_id', sa.String(length=50), nullable=False),
    sa.Column('date_captured', sa.Date(), nullable=False),
    sa.Column('index_type', sa.Enum('ARI', 'ARI2', 'AVI', 'CCCI', 'CIgreen', 'CIRE', 'CVI', 'DSWI4', 'DVI', 'EVI2', 'ExR', 'GEMI', 'GNDVI', 'GOSAVI', 'GRNDVI', 'GRVI', 'GSAVI', 'IPVI', 'LCI', 'MCARI', 'MCARI1', 'MCARI2', 'MGRVI', 'MSAVI', 'MSR', 'MTVI1', 'MTVI2', 'NDRE', 'NDVI', 'NDWI', 'NGRDI', 'NLI', 'OSAVI', 'PVI', 'RDVI', 'RI', 'RRI1', 'SIPI2', 'SR', 'TCARI', 'TCARIOSAVI', 'TNDVI', 'TSAVI', 'WDVI', name='vegetationindexenum'), nullable=False),
